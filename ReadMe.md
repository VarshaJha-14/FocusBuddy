...
| Document | Contents |
|---|---|
| [01 — Product Discovery & Strategy](docs/01-product-discovery-strategy.pdf) | Problem framing, user research insights, personas, JTBD, value proposition, MVP scope, RICE prioritization |
| [02 — PRD & Agile Backlog](docs/02-prd-agile-backlog.pdf) | Product objectives, user stories, acceptance criteria, functional & non-functional requirements, risk register, sprint backlog |
| [03 — AI Feature & Responsible AI](docs/03-ai-feature-responsible-ai.pdf) | AI capability stack, input/output matrix, workflow diagram, data architecture, failure cases, guardrails matrix, transparency strategy |
| [04 — Metrics, Experimentation & GTM](docs/04-metrics-experimentation-gtm.pdf) | North Star Metric, KPI framework, AARRR funnel, A/B test design, dashboard plan, GTM strategy, pricing model |
| [05 — Wireframes & User Flow](docs/05-wireframes-user-flow.pdf) | Core user flow diagram, low-fidelity wireframes, UX design rationale, high-fidelity Figma prototype screens |
| [06 — AI Tool Usage Appendix](docs/06-ai-tool-usage-appendix.pdf) | Transparent log of AI tools used (ChatGPT, Claude, Gemini), prompts used, how outputs were reviewed and modified |
